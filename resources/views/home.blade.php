    ...
    <main id="main">
        ...
        <section id="about" class="about">
            <div class="container" data-aos="fade-up">
                <div class="section-title">
                    <h2>About</h2>
                    <p>Professionals in the field of information technology with a strong focus on Computer Science and
                        are competent in maintaining the security performance of information technology systems. I have
                        strong technical skills, excellent communication skills and a willingness to continuously learn
                        and grow in a rapidly changing industry.</p>
                </div>

                <div class="row">
                    <div class="col-lg-4">
                        <img src="assets/img/profile-img.jpg" class="img-fluid" alt="Gugus Pradita">
                    </div>
                    <div class="col-lg-8 pt-4 pt-lg-0 content">
                        <h3>Network Engineer &amp; Web Developer.</h3>
                        <p class="fst-italic">
                            Enthusiastic about web development and network security, especially backend-related work.
                        </p>
                        <div class="row">
                            <div class="col-lg-6">
                                <ul>
                                    <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>19 Januari
                                            2000</span></li>
                                    <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong>
                                        <span>www.guguspradita.com</span>
                                    </li>
                                    <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>+62 823 3559
                                            3809</span></li>
                                </ul>
                            </div>
                            <div class="col-lg-6">
        ...
        <section id="skills" class="skills section-bg">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    <h2>Skills</h2>
                    <p>A professional in the field of Information Technology with a solid background in web development and
                        network engineering. Possessing expertise in various programming languages such as HTML, CSS,
                        JavaScript, PHP, and utilizing contemporary frameworks like Vue JS and Laravel. As a network
                        engineer, I have a profound understanding of network protocols, security, and network hardware
                        management.</p>
                </div>
                ...
                <div class="row skills-content">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="progress">
                            <span class="skill">Linux Experience <i class="val">75%</i></span>
                            <div class="progress-bar-wrap">
                                <div class="progress-bar" role="progressbar" aria-valuenow="75" aria-valuemin="0"
                                    aria-valuemax="100"></div>
                            </div>
        ...
        <section id="resume" class="resume">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    <h2>Resume</h2>
                    <p>My ability to adapt to technological changes and contribute positively to the success of IT projects
                        reflects my high dedication to professional growth. I am consistent in ensuring that my skills are
                        always up-to-date and relevant, with the goal of achieving excellence in the Information Technology
                        industry.</p>
                </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="resume-item pb-0">
                            ...
                            <ul>
                                ...
                                <li>guguspradita19@gmail.com</li>
                            </ul>
                        </div>
